...
<nav class="navbar bg-nav shadow ">
  <div class="container-fluid">    
    ...
    <a class="navbar-brand" href="./" tabindex="-1" aria-disabled="false"><img src="img/logo.png" width="150"></a>
    <a href="##" class="lh-1">
...
<div class="container-fluid d-flex justify-content-center p-2 bg-nav text-light" id="resulttext">Resultados da pesquisa</div>

<!-- RESULTADOS PESQUISA -->
<main id="resultado" class="container mt-5">
